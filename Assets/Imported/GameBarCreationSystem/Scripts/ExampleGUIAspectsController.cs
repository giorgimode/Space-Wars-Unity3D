...
class ExampleGUIAspectsController : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            fullHealth = GetComponent<PlayerController>().health;
            level1 = true;
        }

        else fullHealth = GetComponent<Health>().health;
        exp_bar.health = fullHealth;
    ...
    public void Update()
    {
        ...
        else health = gameObject.GetComponent<Health>().health;
