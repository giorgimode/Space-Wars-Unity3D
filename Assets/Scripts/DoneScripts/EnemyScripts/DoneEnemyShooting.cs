...
//	private SphereCollider col;							// Reference to the sphere collider.
	...
	void Shoot ()
	{
		...
		// The fractional distance from the player, 1 is next to the player, 0 is the player is at the extent of the sphere collider. //col.radius instead of 10
        float fractionalDistance = (shootDistance - Vector3.Distance(transform.position, player.position)) / shootDistance;
