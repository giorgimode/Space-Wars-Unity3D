...
public class EnemySight : MonoBehaviour {
    ...
    public float sightDistance = 15;                    // Furthest the character can see
    [HideInInspector]
	...
	void CheckSight ()
    {
        ...
        if (targetPlayer!=null)
         direction = targetPlayer.position - transform.position;
			...
			{
				RaycastHit hit;
                Vector3 rayOrigin = new Vector3(transform.position.x, transform.position.y/2.0f, transform.position.z);
				// ... and if a raycast towards the player hits something...
                if (Physics.Raycast(rayOrigin + transform.up, direction.normalized, out hit, sightDistance))
				{
		...
		//	int playerLayerOneStateHash = playerAnim.GetCurrentAnimatorStateInfo(1).nameHash;
            ...
            // *****************IMPLEMENT SOUND DETECTION HERE*******************************************************************************************
