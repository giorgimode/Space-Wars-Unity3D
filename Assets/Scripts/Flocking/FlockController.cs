...
public class FlockController : MonoBehaviour
{
    ...
    public float centerWeight = 1;      //How far the flocks should stick to the center ( the more weight, boids stick closer to the center)
        ...
        if (leader != null)
        {
            ...
            foreach (Flock flock in flockList)
            {
                ...
                {  
                    ...
                    flock.transform.rotation = leader.rotation;
                }
            }
